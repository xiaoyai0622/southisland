...
;(function($) {
	...
	preloaderUrl = templateDir + "/inc/jackbox/php/graphics.php",
	...
	// The url to the social buttons module - DJWD EDIT

	socialbuttons = templateDir + "/inc/jackbox/modules/jackbox_social.php",
