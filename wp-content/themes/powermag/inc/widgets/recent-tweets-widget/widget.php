	...
	class tp_widget_recent_tweets extends WP_Widget {
					...
					if(!empty($tp_twitter_plugin_tweets)){
						...
						<div class="tweet">
							...
							foreach($tp_twitter_plugin_tweets as $tweet){								
								print '<li><span class="tweet_text">'.convert_links($tweet['text']).'</span><br /><a class="tweet_time" target="_blank" href="http://twitter.com/'.$instance['username'].'/statuses/'.$tweet['status_id'].'">'.relative_time($tweet['created_at']).'</a></li>';
						...
						print '
							...
							<a href="http://twitter.com/'.$instance['username'].'/statuses/'.$tweet['status_id'].'" class="twtr-join-conv">' . __('Join the Conversation', 'powermag') . '</a>
						</div>';
					}
		...
		//widget settings form	
			public function form($instance) {
				...
				echo '
				<p><small>In order to obtain the required info you need to <a href="https://dev.twitter.com/apps/" target="_blank">create a new twitter application.</a></small></p>
				<p><label>Title:</label>
