	...
	<div id="primary" class="content-area span8 pm-buddypress">
		<div id="content" class="site-content" role="main">
				...
				<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
					<h1 class="boxed-title"><?php _e( 'Create a Group', 'buddypress' ); ?> &nbsp;<a class="btn btn-primary pull-right" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() ); ?>"><?php _e( 'Groups Directory', 'buddypress' ); ?></a></h1>
					...
					<div class="item-body boxed" id="group-create-body">
						...
						<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
							...
							<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
								...
								<div class="main-column">
									...
									<p>
										<input type="file" name="file" id="file" class="btn-inverse" />
						...
						<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
							...
							<div class="submit" id="previous-next">
								...
								<?php if ( bp_is_first_group_creation_step() ) : ?>
									...
									<input type="submit" value="<?php _e( 'Create Group and Continue', 'buddypress' ); ?>" id="group-creation-create" name="save" class="btn" />
								...
								<?php if ( bp_is_last_group_creation_step() ) : ?>
									...
									<input type="submit" value="<?php _e( 'Finish', 'buddypress' ); ?>" id="group-creation-finish" name="save" class="btn btn-success" />
