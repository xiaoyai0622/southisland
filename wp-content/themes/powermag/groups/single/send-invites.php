			...
			<?php if ( bp_group_has_invites() ) : ?>
				...
				<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
					...
					<li id="<?php bp_group_invite_item_id(); ?>">
						...
						<span class="activity label"><?php bp_group_invite_user_last_active(); ?></span>

						<?php do_action( 'bp_group_send_invites_item' ); ?>

						<div class="action">
							<a class="btn btn-mini btn-danger" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'buddypress' ); ?></a>
