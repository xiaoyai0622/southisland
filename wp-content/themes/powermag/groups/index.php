	...
	<div id="primary" class="content-area span8 pm-buddypress">
		<div id="content" class="site-content" role="main">
			...
			<?php do_action( 'bp_before_directory_groups_page' ); ?>
				...
				<form action="" method="post" id="groups-directory-form" class="dir-form boxed clearfix">
		
					<h1><?php _e( 'Groups Directory', 'buddypress' ); ?></h1>
					
					<?php if ( is_user_logged_in() && bp_user_can_create_groups() ) : ?> &nbsp;<a class="btn btn-primary pull-right" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() . '/create' ); ?>"><?php _e( 'Create a Group', 'buddypress' ); ?></a>			<?php endif; ?>
		
					<?php do_action( 'bp_before_directory_groups_content' ); ?>
		
					<div id="group-dir-search" class="dir-search pull-left" role="search">
