				...
				<?php do_action( 'bp_before_directory_activity_page' ); ?>
					...
					<div class="padder">
						...
						<?php if ( !is_user_logged_in() ) : ?>
							...
							<h1 class="boxed-title"><?php _e('Community', 'powermag')?> <i class="icon-chevron-right arch-chevron"></i><?php _e( 'Site Activity', 'buddypress' ); ?></h1>
						...
						<ul>
							...
							<li class="feed"><a class="pull-right" href="<?php bp_sitewide_activity_feed_link(); ?>" title="<?php _e( 'RSS Feed', 'buddypress' ); ?>"></a></li>
