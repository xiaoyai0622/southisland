		...
		<?php while ( bp_groups() ) : bp_the_group(); ?>
			...
			<li>
				<div class="item-avatar">
					<a href="<?php bp_group_permalink(); ?>"><?php bp_group_avatar( 'width=121&height=121' ); ?></a>
				</div>
				...
				<div class="action">
					<a class="btn btn-mini btn-success accept" href="<?php bp_group_accept_invite_link(); ?>"><?php _e( 'Accept', 'buddypress' ); ?></a> &nbsp;
					<a class="btn btn-mini btn-danger reject confirm" href="<?php bp_group_reject_invite_link(); ?>"><?php _e( 'Reject', 'buddypress' ); ?></a>
...
<?php else: ?>
	...
	<div id="message" class="alert alert-info" role="main">
