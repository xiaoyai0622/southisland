<div id="message-thread" role="main" class="boxed">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<p id="message-recipients">
			...
			<a class="btn btn-mini btn-danger confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php _e( "Delete Message", "buddypress" ); ?>"><?php _e( 'Delete', 'buddypress' ); ?></a> &nbsp;
		</p>
		...
		<?php while ( bp_thread_messages() ) : bp_thread_the_message(); ?>
			...
			<div class="message-box <?php bp_the_thread_message_alt_class(); ?>">
				...
				<div class="message-metadata">
					...
					<strong><a href="<?php bp_the_thread_message_sender_link(); ?>" title="<?php bp_the_thread_message_sender_name(); ?>"><?php bp_the_thread_message_sender_name(); ?></a> <span class="activity label"><?php bp_the_thread_message_time_since(); ?></span></strong>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form" class="btn">
			...
			<div class="message-box">
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" class="btn" name="send" value="<?php _e( 'Send Reply', 'buddypress' ); ?>" id="send_reply_button"/>
					</div>
