						...
						<div class="boxed">
							...
							<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
								...
								<div class="input-prepend">
									...
									<input type="text" name="email" id="email" value="<?php echo bp_get_displayed_user_email(); ?>" class="settings-input" placeholder="<?php esc_attr_e( 'E-mail address', 'buddypress' ); ?>" />
								</div>
								
								<label for="pass1"><?php _e( 'Change Password <span>(leave blank for no change)</span>', 'buddypress' ); ?></label>
								<div class="input-prepend">
									<span class="add-on"><i class="icon-key"></i></span>
									<input type="password" name="pass1" id="pass1" size="16" value="" class="settings-input small" placeholder="<?php esc_attr_e( 'New Password', 'buddypress' ); ?>"/>
								</div>
								
								<div class="input-prepend">
									<span class="add-on"><i class="icon-key"></i></span>
									<input type="password" name="pass2" id="pass2" size="16" value="" class="settings-input small" placeholder="<?php esc_attr_e( 'Repeat New Password', 'buddypress' ); ?>	" /></div>
